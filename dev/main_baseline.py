...
from reinforcement_utils import test, train
...
# Checkpoint Loader:
parser.add_argument('--load-checkpoint', default='pretrained/reinforced_lstm_baseline/checkpoint.pth.tar', type=str,
                    help='path to latest checkpoint (default: none)')

# Network Name:
parser.add_argument('--name', default='reinforced_lstm_baseline', type=str,
                    help='name of file')
...
if __name__ == '__main__':
    ...
    while not done:
        ...
        for epoch in range(args.start_epoch, args.epochs + 1):
            ...
            stats = train.train(q_network, epoch, optimizer, train_loader, args, rl, episode, criterion)
