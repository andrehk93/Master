...
# Checkpoint Loader:
parser.add_argument('--load-checkpoint', default='pretrained/headlines_lrua_r2/checkpoint.pth.tar', type=str,
                    help='path to latest checkpoint (default: none)')

# Checkpoint Loader:
parser.add_argument('--load-best-checkpoint', default='pretrained/headlines_lrua_r2/best.pth.tar', type=str,
                    help='path to best checkpoint (default: none)')

# Checkpoint Loader:
parser.add_argument('--load-test-checkpoint', default='pretrained/headlines_lrua_r2/testpoint.pth.tar', type=str,
                    help='path to best checkpoint (default: none)')

# Network Name:
parser.add_argument('--name', default='headlines_lrua_r2', type=str,
                    help='name of file')
