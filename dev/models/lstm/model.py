...
class ReinforcedLSTM(nn.Module):
    def __init__(self, INPUT_SIZE, HIDDEN_NODES, HIDDEN_LAYERS, OUTPUT_CLASSES, BATCH_SIZE, CUDA, EMBEDDING=False, DICT_SIZE=5000):
        ...
        print("Model Input Size: ", str(self.input_size + self.output_size))
        ...
        # Architecture
        self.lstm = nn.LSTM(self.input_size + self.output_size, self.hidden_nodes)
