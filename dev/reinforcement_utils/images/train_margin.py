...
def train(q_network, epoch, optimizer, train_loader, args, reinforcement_learner, episode, criterion, multi_state=False, state_size=5, margin=2):
    ...
    image_batch, label_batch = margin_selection(image_batch, label_batch, q_network, hidden, state, margin*args.class_vector_size)
