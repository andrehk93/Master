...
# Checkpoint Loader:
parser.add_argument('--load-checkpoint', default='pretrained/q_target_networks/checkpoint.pth.tar', type=str,
                    help='path to latest checkpoint (default: none)')

# Network Name:
parser.add_argument('--name', default='q_target_network', type=str,
                    help='name of file')
...
if __name__ == '__main__':
    ...
    target_network = model.ReinforcedLSTM(IMAGE_SIZE, HIDDEN_NODES, HIDDEN_LAYERS, OUTPUT_CLASSES,
                                  args.batch_size, args.cuda)
